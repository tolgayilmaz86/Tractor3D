...
class AIMessage
{
  ...
  public:
     ...
     */
    static AIMessage* create(unsigned int id,
     ...
     */
    const std::string& getSender() const noexcept { return _sender; }
     ...
     */
    const std::string& getReceiver() const noexcept { return _receiver; }
     ...
     */
    unsigned int getParameterCount() const noexcept { return _parameterCount; }
  ...
  private:
     ...
     * to be delivered.
     */
    double getDeliveryTime() const noexcept { return _deliveryTime; }
