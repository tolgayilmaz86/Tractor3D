...
class Mesh
{
  ...
  public:
     ...
     * @script{create}
     */
    static std::shared_ptr<Mesh> createMesh(const VertexFormat& vertexFormat,
     ...
     * @script{create}
     */
    static std::shared_ptr<Mesh> createQuad(const Vector3& p1,
                                            const Vector3& p2,
                                            const Vector3& p3,
                                            const Vector3& p4);
     ...
     * @script{create}
     */
    static std::shared_ptr<Mesh> createQuad(float x,
                                            float y,
                                            float width,
                                            float height,
                                            float s1 = 0.0f,
     ...
     */
    [[nodiscard]]
    MeshPart* addPart(PrimitiveType primitiveType,
