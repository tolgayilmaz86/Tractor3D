  ...
  public:
    ...
    class CollisionListener
    {
      ...
      public:
         ...
         *
         * NOTE: You are not permitted to disable physics objects from within this callback.
         * Disabling physics on a collision object removes the object from the physics world. This
         * is not permitted during the PhysicsController::update.
         *
    ...
    void removeCollisionListener(CollisionListener* listener,
                                 PhysicsCollisionObject* object = nullptr);
  ...
  private:
    ...
    class PhysicsMotionState : public btMotionState
    {
      ...
      public:
         ...
         */
        PhysicsMotionState(Node* node,
                           PhysicsCollisionObject* collisionObject,
                           const Vector3* centerOfMassOffset = nullptr);
