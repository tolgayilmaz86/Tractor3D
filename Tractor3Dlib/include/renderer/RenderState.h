...
class RenderState : public Ref
{
  ...
  public:
    ...
    class AutoBindingResolver
    {
      public:
         ...
         */
        virtual bool resolveAutoBinding(const std::string& autoBinding,
                                        Node* node,
    ...
    class StateBlock : public Ref
    {
      ...
      public:
         ...
         *
         * By default, stencil fail, stencil pass/depth fail, and stencil and depth pass are set to
         * STENCIL_OP_KEEP.
         *
         ...
         */
        void setStencilOperation(StencilOperation sfail,
  ...
  protected:
     ...
     */
    RenderState* getTopmost(RenderState* below) noexcept;
