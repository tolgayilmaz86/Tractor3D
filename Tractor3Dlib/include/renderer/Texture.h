...
class Texture : public Ref
{
  ...
  public:
    ...
    class Sampler : public Ref
    {
      ...
      public:
         ...
         * @param generateMipmaps True to force a full mipmap chain to be generated for the texture,
         * false otherwise.
         *
         * @return The new sampler.
         * @script{create}
     ...
     *
     * Note that for textures that include mipmap data in the source data (such as most compressed
     * textures), the generateMipmaps flags should NOT be set to true.
     *
  ...
  private:
    ...
    static GLubyte* readCompressedPVRTCLegacy(const std::string& path,
                                              Stream* stream,
                                              GLsizei* width,
                                              GLsizei* height,
                                              GLenum* format,
