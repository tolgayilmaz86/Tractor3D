...
namespace tractor
{
	...
	public:
		 ...
		 * @script{ignore}
		 */
		unsigned int findNodes(const std::string& id, std::vector<Node*>& nodes, bool recursive = true, bool exactMatch = true) const;
	...
	protected:
		 ...
		 * @return The Node found or nullptr if not found.
		 */
		Node* findNode(const std::string& id, bool recursive, bool exactMatch, bool skipSkin) const;
		 ...
		 * @script{ignore}
		 */
		unsigned int findNodes(const std::string& id, std::vector<Node*>& nodes, bool recursive, bool exactMatch, bool skipSkin) const;
