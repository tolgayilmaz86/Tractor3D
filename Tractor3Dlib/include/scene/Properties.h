 ...
 * Reading the spriteTexture properties out of the file above in this way could be done with the
 following code:
...
class Properties
{
  ...
  public:
     ...
     *
     * @param name The name of the property to interpret, or nullptr to return the current
     * property's value.
     * @param defaultValue the default value to return if the specified property does not exist
