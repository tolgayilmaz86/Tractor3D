...
namespace tractor
{
	...
	public:
		 ...
		 */
		Properties* getNamespace(const std::string& id, bool searchNames = false, bool recurse = true) const;
		 ...
		 */
		Type getType(const std::string& name = EMPTY_STRING) const;
		 ...
		 */
		bool getBool(const std::string& name = EMPTY_STRING, bool defaultValue = false) const;
		 ...
		 */
		int getInt(const std::string& name = EMPTY_STRING) const;
		 ...
		 *   Zero if the property does not exist or could not be scanned.
		 */
		float getFloat(const std::string& name = EMPTY_STRING) const;
		 ...
		 *   Zero if the property does not exist or could not be scanned.
		 */
		long getLong(const std::string& name = EMPTY_STRING) const;
		 ...
		 */
		bool getMatrix(const std::string& name, Matrix* out) const;
		 ...
		 * @return True on success, false if the property does not exist or could not be scanned.
		 */
		bool getVector2(const std::string& name, Vector2* out) const;
		 ...
		 * @return True on success, false if the property does not exist or could not be scanned.
		 */
		bool getVector3(const std::string& name, Vector3* out) const;
		 ...
		 * @return True on success, false if the property does not exist or could not be scanned.
		 */
		bool getVector4(const std::string& name, Vector4* out) const;
		 ...
		 * @return True on success, false if the property does not exist or could not be scanned.
		 */
		bool getQuaternionFromAxisAngle(const std::string& name, Quaternion* out) const;
		 ...
		 * @return True on success, false if the property does not exist or could not be scanned.
		 */
		bool getColor(const std::string& name, Vector3* out) const;
		 ...
		 * @return True on success, false if the property does not exist or could not be scanned.
		 */
		bool getColor(const std::string& name, Vector4* out) const;
		 ...
		 */
		const std::string& getVariable(const std::string& name, const std::string& defaultValue = EMPTY_STRING) const;
		 ...
		 */
		static bool parseVector2(const std::string& str, Vector2* out);
		 ...
		 */
		static bool parseVector3(const std::string& str, Vector3* out);
		 ...
		 */
		static bool parseVector4(const std::string& str, Vector4* out);
		 ...
		 */
		static bool parseAxisAngle(const std::string& str, Quaternion* out);
		 ...
		 */
		static bool parseColor(const std::string& str, Vector3* out);
		...
		void addNamespace(Stream* stream, const std::string& name, const std::string& id, const std::string& parentID, Properties* parent, int nestingDepth);
	...
	private:
		 ...
		 */
		Properties(Stream* stream, const std::string& name, const std::string& id, const std::string& parentID, Properties* parent, int nestingDepth);
