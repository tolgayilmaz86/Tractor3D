...
#define GP_SCRIPT_EVENT(eventName, eventArgs)                                                      \
    ...
    {                                                                                              \
        ...
        const ScriptTarget::Event* getEvent() { return _event; }                                   \
                                                                                                   \
      private:                                                                                     \
...
class ScriptTarget
{
  ...
  public:
     ...
     * @param function The name of the script function to call when the event is fired; can either
     * be just the name of a function (if the function's script file has already been loaded), or
     * can be a URL of the form scriptFile.lua#functionName.
     */
