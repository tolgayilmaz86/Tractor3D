...
static tractor::Keyboard::Key getKey(WPARAM win32KeyCode, bool shiftDown)
{
  switch (win32KeyCode)
  {
  case VK_PAUSE:
    return tractor::Keyboard::KEY_PAUSE;
  case VK_SCROLL:
    return tractor::Keyboard::KEY_SCROLL_LOCK;
  case VK_PRINT:
    return tractor::Keyboard::KEY_PRINT;
  case VK_ESCAPE:
    return tractor::Keyboard::KEY_ESCAPE;
  case VK_BACK:
  case VK_F16: // generated by CTRL + BACKSPACE
    return tractor::Keyboard::KEY_BACKSPACE;
  case VK_TAB:
    return shiftDown ? tractor::Keyboard::KEY_BACK_TAB : tractor::Keyboard::KEY_TAB;
  case VK_RETURN:
    return tractor::Keyboard::KEY_RETURN;
  case VK_CAPITAL:
    return tractor::Keyboard::KEY_CAPS_LOCK;
  case VK_SHIFT:
    return tractor::Keyboard::KEY_SHIFT;
  case VK_CONTROL:
    return tractor::Keyboard::KEY_CTRL;
  case VK_MENU:
    return tractor::Keyboard::KEY_ALT;
  case VK_APPS:
    return tractor::Keyboard::KEY_MENU;
  case VK_LSHIFT:
    return tractor::Keyboard::KEY_SHIFT;
  case VK_RSHIFT:
    return tractor::Keyboard::KEY_SHIFT;
  ...
  case VK_LWIN:
  case VK_RWIN:
    return tractor::Keyboard::KEY_HYPER;
  case VK_BROWSER_SEARCH:
    return tractor::Keyboard::KEY_SEARCH;
  case VK_INSERT:
    return tractor::Keyboard::KEY_INSERT;
  case VK_HOME:
    return tractor::Keyboard::KEY_HOME;
  case VK_PRIOR:
    return tractor::Keyboard::KEY_PG_UP;
  case VK_DELETE:
    return tractor::Keyboard::KEY_DELETE;
  case VK_END:
    return tractor::Keyboard::KEY_END;
  case VK_NEXT:
    return tractor::Keyboard::KEY_PG_DOWN;
  case VK_LEFT:
    return tractor::Keyboard::KEY_LEFT_ARROW;
  case VK_RIGHT:
    return tractor::Keyboard::KEY_RIGHT_ARROW;
  case VK_UP:
    return tractor::Keyboard::KEY_UP_ARROW;
  case VK_DOWN:
    return tractor::Keyboard::KEY_DOWN_ARROW;
  case VK_NUMLOCK:
    return tractor::Keyboard::KEY_NUM_LOCK;
  case VK_ADD:
    return tractor::Keyboard::KEY_KP_PLUS;
  case VK_SUBTRACT:
    return tractor::Keyboard::KEY_KP_MINUS;
  case VK_MULTIPLY:
    return tractor::Keyboard::KEY_KP_MULTIPLY;
  case VK_DIVIDE:
    return tractor::Keyboard::KEY_KP_DIVIDE;
  case VK_NUMPAD7:
    return tractor::Keyboard::KEY_KP_HOME;
  case VK_NUMPAD8:
    return tractor::Keyboard::KEY_KP_UP;
  case VK_NUMPAD9:
    return tractor::Keyboard::KEY_KP_PG_UP;
  case VK_NUMPAD4:
    return tractor::Keyboard::KEY_KP_LEFT;
  case VK_NUMPAD5:
    return tractor::Keyboard::KEY_KP_FIVE;
  case VK_NUMPAD6:
    return tractor::Keyboard::KEY_KP_RIGHT;
  case VK_NUMPAD1:
    return tractor::Keyboard::KEY_KP_END;
  case VK_NUMPAD2:
    return tractor::Keyboard::KEY_KP_DOWN;
  case VK_NUMPAD3:
    return tractor::Keyboard::KEY_KP_PG_DOWN;
  case VK_NUMPAD0:
    return tractor::Keyboard::KEY_KP_INSERT;
  case VK_DECIMAL:
    return tractor::Keyboard::KEY_KP_DELETE;
  case VK_F1:
    return tractor::Keyboard::KEY_F1;
  case VK_F2:
    return tractor::Keyboard::KEY_F2;
  case VK_F3:
    return tractor::Keyboard::KEY_F3;
  case VK_F4:
    return tractor::Keyboard::KEY_F4;
  case VK_F5:
    return tractor::Keyboard::KEY_F5;
  case VK_F6:
    return tractor::Keyboard::KEY_F6;
  case VK_F7:
    return tractor::Keyboard::KEY_F7;
  case VK_F8:
    return tractor::Keyboard::KEY_F8;
  case VK_F9:
    return tractor::Keyboard::KEY_F9;
  case VK_F10:
    return tractor::Keyboard::KEY_F10;
  case VK_F11:
    return tractor::Keyboard::KEY_F11;
  case VK_F12:
    return tractor::Keyboard::KEY_F12;
  case VK_SPACE:
    return tractor::Keyboard::KEY_SPACE;
  case 0x30:
    return shiftDown ? tractor::Keyboard::KEY_RIGHT_PARENTHESIS : tractor::Keyboard::KEY_ZERO;
  case 0x31:
    return shiftDown ? tractor::Keyboard::KEY_EXCLAM : tractor::Keyboard::KEY_ONE;
  case 0x32:
    return shiftDown ? tractor::Keyboard::KEY_AT : tractor::Keyboard::KEY_TWO;
  case 0x33:
    return shiftDown ? tractor::Keyboard::KEY_NUMBER : tractor::Keyboard::KEY_THREE;
  case 0x34:
    return shiftDown ? tractor::Keyboard::KEY_DOLLAR : tractor::Keyboard::KEY_FOUR;
  case 0x35:
    return shiftDown ? tractor::Keyboard::KEY_PERCENT : tractor::Keyboard::KEY_FIVE;
  case 0x36:
    return shiftDown ? tractor::Keyboard::KEY_CIRCUMFLEX : tractor::Keyboard::KEY_SIX;
  case 0x37:
    return shiftDown ? tractor::Keyboard::KEY_AMPERSAND : tractor::Keyboard::KEY_SEVEN;
  case 0x38:
    return shiftDown ? tractor::Keyboard::KEY_ASTERISK : tractor::Keyboard::KEY_EIGHT;
  case 0x39:
    return shiftDown ? tractor::Keyboard::KEY_LEFT_PARENTHESIS : tractor::Keyboard::KEY_NINE;
  case VK_OEM_PLUS:
    return shiftDown ? tractor::Keyboard::KEY_EQUAL : tractor::Keyboard::KEY_PLUS;
  case VK_OEM_COMMA:
    return shiftDown ? tractor::Keyboard::KEY_LESS_THAN : tractor::Keyboard::KEY_COMMA;
  case VK_OEM_MINUS:
    return shiftDown ? tractor::Keyboard::KEY_UNDERSCORE : tractor::Keyboard::KEY_MINUS;
  case VK_OEM_PERIOD:
    return shiftDown ? tractor::Keyboard::KEY_GREATER_THAN : tractor::Keyboard::KEY_PERIOD;
  case VK_OEM_1:
    return shiftDown ? tractor::Keyboard::KEY_COLON : tractor::Keyboard::KEY_SEMICOLON;
  case VK_OEM_2:
    return shiftDown ? tractor::Keyboard::KEY_QUESTION : tractor::Keyboard::KEY_SLASH;
  case VK_OEM_3:
    return shiftDown ? tractor::Keyboard::KEY_TILDE : tractor::Keyboard::KEY_GRAVE;
  case VK_OEM_4:
    return shiftDown ? tractor::Keyboard::KEY_LEFT_BRACE : tractor::Keyboard::KEY_LEFT_BRACKET;
  case VK_OEM_5:
    return shiftDown ? tractor::Keyboard::KEY_BAR : tractor::Keyboard::KEY_BACK_SLASH;
  case VK_OEM_6:
    return shiftDown ? tractor::Keyboard::KEY_RIGHT_BRACE : tractor::Keyboard::KEY_RIGHT_BRACKET;
  case VK_OEM_7:
    return shiftDown ? tractor::Keyboard::KEY_QUOTE : tractor::Keyboard::KEY_APOSTROPHE;
  case 0x41:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_A : tractor::Keyboard::KEY_A;
  case 0x42:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_B : tractor::Keyboard::KEY_B;
  case 0x43:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_C : tractor::Keyboard::KEY_C;
  case 0x44:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_D : tractor::Keyboard::KEY_D;
  case 0x45:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_E : tractor::Keyboard::KEY_E;
  case 0x46:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_F : tractor::Keyboard::KEY_F;
  case 0x47:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_G : tractor::Keyboard::KEY_G;
  case 0x48:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_H : tractor::Keyboard::KEY_H;
  case 0x49:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_I : tractor::Keyboard::KEY_I;
  case 0x4A:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_J : tractor::Keyboard::KEY_J;
  case 0x4B:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_K : tractor::Keyboard::KEY_K;
  case 0x4C:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_L : tractor::Keyboard::KEY_L;
  case 0x4D:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_M : tractor::Keyboard::KEY_M;
  case 0x4E:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_N : tractor::Keyboard::KEY_N;
  case 0x4F:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_O : tractor::Keyboard::KEY_O;
  case 0x50:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_P : tractor::Keyboard::KEY_P;
  case 0x51:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_Q : tractor::Keyboard::KEY_Q;
  case 0x52:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_R : tractor::Keyboard::KEY_R;
  case 0x53:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_S : tractor::Keyboard::KEY_S;
  case 0x54:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_T : tractor::Keyboard::KEY_T;
  case 0x55:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_U : tractor::Keyboard::KEY_U;
  case 0x56:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_V : tractor::Keyboard::KEY_V;
  case 0x57:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_W : tractor::Keyboard::KEY_W;
  case 0x58:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_X : tractor::Keyboard::KEY_X;
  case 0x59:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_Y : tractor::Keyboard::KEY_Y;
  case 0x5A:
    return shiftDown ? tractor::Keyboard::KEY_CAPITAL_Z : tractor::Keyboard::KEY_Z;
  default:
    return tractor::Keyboard::KEY_NONE;
  }
}
...
LRESULT CALLBACK __WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
  ...
  case WM_LBUTTONUP:
  {
    ...
    if (!tractor::Platform::mouseEventInternal(tractor::Mouse::MOUSE_RELEASE_LEFT_BUTTON, x, y, 0))
    {
  ...
  case WM_RBUTTONDOWN:
    UpdateCapture(wParam);
    tractor::Platform::mouseEventInternal(tractor::Mouse::MOUSE_PRESS_RIGHT_BUTTON, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam), 0);
    break;

  case WM_RBUTTONUP:
    tractor::Platform::mouseEventInternal(tractor::Mouse::MOUSE_RELEASE_RIGHT_BUTTON, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam), 0);
    UpdateCapture(wParam);
    break;

  case WM_MBUTTONDOWN:
    UpdateCapture(wParam);
    tractor::Platform::mouseEventInternal(tractor::Mouse::MOUSE_PRESS_MIDDLE_BUTTON, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam), 0);
    break;

  case WM_MBUTTONUP:
    tractor::Platform::mouseEventInternal(tractor::Mouse::MOUSE_RELEASE_MIDDLE_BUTTON, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam), 0);
    UpdateCapture(wParam);
    break;
  ...
  case WM_MOUSEWHEEL:
    ...
    tractor::Platform::mouseEventInternal(tractor::Mouse::MOUSE_WHEEL, point.x, point.y, GET_WHEEL_DELTA_WPARAM(wParam) / 120);
    break;
  ...
  case WM_KEYDOWN:
    ...
    tractor::Platform::keyEventInternal(tractor::Keyboard::KEY_PRESS, getKey(wParam, shiftDown ^ capsOn));
    break;
  ...
  case WM_KEYUP:
    ...
    tractor::Platform::keyEventInternal(tractor::Keyboard::KEY_RELEASE, getKey(wParam, shiftDown ^ capsOn));
    break;
  ...
  case WM_SIZE:
    // Window was resized.
    tractor::Platform::resizeEventInternal((unsigned int)(short)LOWORD(lParam), (unsigned int)(short)HIWORD(lParam));
    break;
  }
