...
namespace tractor
{
	...
	ParticleEmitter* ParticleEmitter::create(const std::string& textureFile, BlendMode blendMode, unsigned int particleCountMax)
	{
	...
	ParticleEmitter* ParticleEmitter::create(const std::string& url)
	{
		...
		ParticleEmitter* particle = create(properties->getNamespace().length() > 0 ? properties : properties->getNextNamespace());
