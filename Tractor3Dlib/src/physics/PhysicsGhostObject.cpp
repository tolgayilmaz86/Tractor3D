...
PhysicsGhostObject* PhysicsGhostObject::create(Node* node, Properties* properties)
{
    ...
    {
        GP_ERROR("Failed to load ghost object from properties object: must be non-null object and "
    ...
    if (type.empty())
    {
        GP_ERROR("Failed to load ghost object from properties object; required attribute 'type' is "
                 "missing.");
        return nullptr;
    }
    ...
    {
        GP_ERROR("Failed to load ghost object from properties object; attribute 'type' must be "
                 "equal to 'GHOST_OBJECT'.");
        return nullptr;
    }
