...
class ClosestNotMeRayResultCallback : public btCollisionWorld::ClosestRayResultCallback
{
  public:
    ...
    {
        if (rayResult.m_collisionObject == static_cast<const btCollisionObject*>(_me)) return 1.0f;
