...
namespace tractor
{
	...
	const std::string& Theme::ThemeImage::getId() const
	{
		return _id;
	}
	...
	const std::string& Theme::ImageList::getId() const
	{
		return _id;
	}
	 ...
	 * Theme::Skin *
	 ***************/
	Theme::Skin* Theme::Skin::create(const std::string& id, float tw, float th, const Rectangle& region, const Theme::Border& border, const Vector4& color)
	{
	...
	const std::string& Theme::Skin::getId() const
	{
		return _id;
	}
