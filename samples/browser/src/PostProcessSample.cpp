...
PostProcessSample::Compositor* PostProcessSample::Compositor::create(FrameBuffer* srcBuffer, FrameBuffer* dstBuffer, const std::string& materialPath, const std::string& techniqueId)
{
	assert(srcBuffer);
...
PostProcessSample::Compositor::Compositor(FrameBuffer* srcBuffer, FrameBuffer* dstBuffer, Material* material, const std::string& techniqueId)
...
const std::string& PostProcessSample::Compositor::getTechniqueId() const
{
	return _techniqueId;
}
