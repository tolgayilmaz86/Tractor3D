...
SpriteBatchSample::SpriteBatchSample() : _font(nullptr), _spriteBatch(nullptr) {}
...
void SpriteBatchSample::render(float elapsedTime)
{
    ...
    // rotate 90
    _spriteBatch->draw(Vector3(128, 64, 0),
                       src,
                       Vector2(128, 128),
                       Vector4(1, 1, 1, 1),
                       Vector2(0.5f, 0.5f),
                       MATH_DEG_TO_RAD(90));
    _spriteBatch->draw(Vector3(256, 64, 0),
                       src,
                       Vector2(128, 128),
                       Vector4(1, 1, 1, 1),
                       Vector2(0.5f, 0.5f),
                       MATH_DEG_TO_RAD(180));
    _spriteBatch->draw(Vector3(384, 64, 0),
                       src,
                       Vector2(128, 128),
                       Vector4(1, 1, 1, 1),
                       Vector2(0.5f, 0.5f),
                       MATH_DEG_TO_RAD(270));
    _spriteBatch->draw(Vector3(512, 64, 0),
                       src,
                       Vector2(128, 128),
                       Vector4(1, 1, 1, 1),
                       Vector2(0.5f, 0.5f),
                       MATH_DEG_TO_RAD(360));
    _spriteBatch->draw(Vector3(640, 64, 0),
                       src,
                       Vector2(128, 128),
                       Vector4(1, 1, 1, 1),
                       Vector2(0.5f, 0.5f),
