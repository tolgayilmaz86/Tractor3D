...
SpriteSample::SpriteSample()
    : _font(nullptr), _scene(nullptr), _cameraNode(nullptr), _playerSprite(nullptr),
      _playerNode(nullptr), _playerAnimation(nullptr), _playerMovement(0)
{
}
...
void SpriteSample::initialize()
{
    ...
    _playerAnimation = _playerSprite->createAnimation("player-animations",
                                                      Sprite::ANIMATE_KEYFRAME,
                                                      4,
                                                      keyTimes,
                                                      keyValues,
                                                      Curve::LINEAR);
...
float SpriteSample::getTime() const
{
    ...
    if (angle > MATH_PIX2) angle -= MATH_PIX2;
    return angle;
}
