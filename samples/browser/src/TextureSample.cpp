...
TextureSample::TextureSample() : _font(nullptr), _scene(nullptr), _zOffset(0.0f) {}
...
void TextureSample::initialize()
{
    ...
    // Textured quad mesh
    {
        ...
        //_text.push_back(Text::create("res/ui/arial.gpb", "Quad: Textured", Rectangle(x, y,
        // textWidth, fontSize), Vector4::one(), fontSize, Font::ALIGN_TOP_HCENTER, false));
    }
    // Textured quad points
    {
        auto mesh = Mesh::createQuad(Vector3(0, cubeSize, 0),
                                     Vector3(0, 0, 0),
        ...
        _scene->getActiveCamera()->project(getViewport(), node->getTranslationWorld(), &x, &y);
        //_text.push_back(_font->createText("Quad: Points", Rectangle(x, y, textWidth, fontSize),
        // Vector4::one(), fontSize, Font::ALIGN_TOP_HCENTER, false));
    }
    // Texture clamp
    {
        ...
        _scene->getActiveCamera()->project(getViewport(), node->getTranslationWorld(), &x, &y);
        //_text.push_back(_font->createText("Wrap: Clamp", Rectangle(x, y, textWidth, fontSize),
        // Vector4::one(), fontSize, Font::ALIGN_TOP_HCENTER, false));
    }
    // Texture wrapped+repeat
    {
        ...
        _scene->getActiveCamera()->project(getViewport(), node->getTranslationWorld(), &x, &y);
        //_text.push_back(_font->createText("Wrap: Repeat", Rectangle(x, y, textWidth, fontSize),
        // Vector4::one(), fontSize, Font::ALIGN_HCENTER, false));
    }
    // Mipmapping Off
    {
        Node* node = addQuadModelAndNode(_scene, 0, 0, cubeSize, cubeSize);
        ...
        _scene->getActiveCamera()->project(getViewport(), node->getTranslationWorld(), &x, &y);
        //_text.push_back(_font->createText("MipMap: Off", Rectangle(x, y, textWidth, fontSize),
        // Vector4::one(), fontSize, Font::ALIGN_HCENTER, false));
    }
    // Mipmapping On
    {
        ...
        _scene->getActiveCamera()->project(getViewport(), node->getTranslationWorld(), &x, &y);
        //_text.push_back(_font->createText("MipMap: On", Rectangle(x, y, textWidth, fontSize),
        // Vector4::one(), fontSize, Font::ALIGN_HCENTER, false));
    }
}
